...
train_df = pd.read_csv(r'C:\Users\Ahmed Shafique\Documents\Projects\AI Powered Enviromental Monitoring for Carbon Detection\AI-Powered-Environment-Monitoring-for-Carbon-Emission-Detection\Finalized dataset\dataset2022.csv')
X_train = train_df.drop(['avg_temp', 'time', 'year', 'month', 'hour'], axis=1)
y_train = train_df['co']
